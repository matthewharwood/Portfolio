export const data = {
  ...
  highlightBlockDataOne: {
    isImageRight: true,
    imageCols: 7,
    subtitle: "01",
    title: "Getting started",
    text:
      "Lorem ipsum dolor sit amet consectetur adipisicing elit. Nobis vel quod tenetur aperiam quaerat. Fugit iste, officiis labore in laborum debitis sapiente eaque impedit quod expedita at, distinctio ducimus alias.",
    image: "https://via.placeholder.com/800x600",
  },
  highlightBlockDataTwo: {
    subtitle: "02",
    title: "Identifying Pain Points",
    text: `Our design prompt was but a utterance over lunch about replacing a leaving employee with a robot.  We were unsure of what we were out to solve. Regardless, we put on our designers hats and went to best resource we knew at the time IDEO’s Method Cards. We better shaped our problem by journey mapping the process between AKQA and Nike 2014’s March Madness Campaign. Our journey map reveal that the process had many pain points: 
...
`,
  ...
  cardTileBlockData: {
    cards: [
      ...
      {
        title: "Typography",
        subtitle: "Jordan Druk",
        image: "https://via.placeholder.com/300",
      },
    ],
    hasBackground: true,
  },
  headlineBlockDataThree: {
    title: "Interface",
    text:
  ...
  summaryBlockDataThree: {
    number: "05",
    heading: "Technology Execution",
    text:
  ...
  headlineBlockDataSeven: {
    title: "Challenge #2",
    text: "How to synchronize user interaction across many applications",
    hasBackground: false,
  },
  headlineBlockDataEight: {
    title: "Solution",
    text:
  ...
  headlineBlockDataTen: {
    title: "Challenge #2",
    text: "How to synchronize user interaction across many applications",
    hasBackground: false,
  },
  headlineBlockDataEleven: {
    title: "Solution",
    text:
      "Real time interactively is a hard problem, so we relied proven libraries to manage it for use.",
    hasBackground: false,
  },
  cardTilesTwoDataNodeWebkit: {
    cards: [
      {
        title: "AngularJS",
        subtitle: "Frontend Framework",
  ...
  highlightBlockDataThree: {
    isImageRight: false,
    imageCols: 4,
    subtitle: "07",
    title: "Test / Mesaure / Iterate",
    text:
