...
const WorkItem = () => {
  return html`
    <div className="h-screen p-10 relative">
      ...
      >
        <div className="flex flex-col items-center justify-center px-16 w-full md:w-10/12 lg:w-8/12 xl:w-7/12">
          <h1 className="text-4xl md:text-5xl lg:text-6xl">Stanley Editor</h1>
          <span className="text-lg md:text-2xl mt-3 mb-10"
            >Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestiae
            et iure ab ea, fugiat minus?</span
          >
          <a
            href="/"
