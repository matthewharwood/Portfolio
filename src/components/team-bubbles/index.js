...
const Teammate = (props) =>{
  ...
  return html`
      ${props.name && props.title && html`
        ...
        </div><div className="absolute bottom-1/10 left-1/2 flex flex-col items-start">
...
const TeamBubbles = (props) => {
  return html`
    <section className="">
      <div className="container grid grid-cols-1 lg:grid-cols-4 gap-20  px-5 lg:px-16 py-8 lg:py-16 ">
